              ...
              >
                ...
                <div className="outline-none">
                  <div className="h-[280px] sm:h-[400px] bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#0f172a] text-white p-6 sm:p-12 flex items-center justify-between relative overflow-hidden">
                    ...
                    <div className="flex-1 z-10 max-w-[60%] sm:max-w-[50%] relative">
                      <span className="inline-flex bg-gradient-to-r from-[#ffdc2b] to-[#e6c600] text-[#1a202c] text-[10px] font-black uppercase px-3 py-1 rounded-full w-fit mb-3 shadow-sm shadow-[#ffdc2b]/20">
                        Import B2B
                      </span>
                ...
                <div className="outline-none">
                  <div className="h-[280px] sm:h-[400px] bg-gradient-to-r from-blue-900 to-indigo-900 text-white p-6 sm:p-12 flex items-center justify-between">
                    <div className="flex-1 z-10 max-w-[60%] sm:max-w-[50%]">
                      <span className="inline-flex bg-blue-100 text-blue-800 text-[10px] font-black uppercase px-3 py-1 rounded-full w-fit mb-3 shadow-sm">
                        Livraison
                      </span>
                ...
                <div className="outline-none">
                  <div className="h-[280px] sm:h-[400px] bg-gradient-to-r from-rose-900 to-pink-800 text-white p-6 sm:p-12 flex items-center justify-between">
                    <div className="flex-1 z-10 max-w-[60%] sm:max-w-[50%]">
                      <span className="inline-flex bg-rose-100 text-rose-800 text-[10px] font-black uppercase px-3 py-1 rounded-full w-fit mb-3 shadow-sm">
                        Inspection
                      </span>
                      <h1 className="text-2xl sm:text-4xl font-black leading-tight mb-2">
                        Contrôle Qualité
        ...
        <section className="py-16 px-6 lg:px-8 max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-3xl p-8 border border-gray-200 shadow-sm">
              <h3 className="text-lg font-bold text-gray-900 mb-5">Ce qui nous distingue</h3>
            ...
            <div className="md:col-span-2 bg-[#ffdc2b] rounded-3xl p-8 sm:p-10 flex flex-col sm:flex-row items-center gap-8 justify-between">
              ...
              <button 
                ...
                className="bg-gray-900 text-white hover:bg-black px-8 py-4 rounded-full font-black whitespace-nowrap shadow-lg transition-transform hover:scale-105 active:scale-95"
              >
                Commencer
              </button>
            </div>
