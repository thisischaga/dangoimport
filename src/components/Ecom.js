...
import chouchou from '../images/product4.jpg';
import levre from '../images/product6.jpg';
import pince from '../images/product5.jpg';
...
const Ecom = () => {
  ...
  const productFour = {
      ...
      price: '1 000',
      name: 'Chouchou',
      description: "Chouchou pour attraper les cheuveux (tresses, mèches, perruques) bien résistant"
  };
  const productFive = {
    id: 5,
    productImg: pince,
    price: "1 500",
    name: 'Pince',
    description: "Pinnce pour garder des cheuveux (tresses, mèches, perruques) "
  };
  const productSix = {
    id: 5,
    productImg: levre,
